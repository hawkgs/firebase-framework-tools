...
class ToastsService {
    _toasts = signal(List([]));
    value = this._toasts.asReadonly();
    create(text, config) {
        const toast = new Toast(text, this._toasts, config);
        this._toasts.update((l) => l.push(toast));
        return toast.destroyPromise;
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.2", ngImport: i0, type: ToastsService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.2", ngImport: i0, type: ToastsService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.2", ngImport: i0, type: ToastsService, decorators: [{
            type: Injectable,
...
class ToastOutletComponent {
    ...
    default = computed(() => this.toasts.value().filter((t) => t.config.type === ToastType.Default));
    notifications = computed(() => this.toasts.value().filter((t) => t.config.type === ToastType.Notification));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.2", ngImport: i0, type: ToastOutletComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.2", type: ToastOutletComponent, isStandalone: true, selector: "ngx-toast-outlet", ngImport: i0, template: "<div class=\"outlet default\">\n  @for (toast of default(); track toast.createdAt) {\n    <ngx-toast [toast]=\"toast\" />\n  }\n</div>\n<div class=\"outlet notifications\">\n  @for (toast of notifications(); track toast.createdAt) {\n    <ngx-toast [toast]=\"toast\" />\n  }\n</div>\n", styles: [":host .outlet{position:fixed;width:100%;height:0}:host .outlet.default{top:0;left:0;display:flex;flex-direction:column;align-items:center}:host .outlet.notifications{bottom:16px;left:0;display:flex;flex-direction:column-reverse;align-items:flex-start}\n"], dependencies: [{ kind: "component", type: ToastComponent, selector: "ngx-toast", inputs: ["toast"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.2", ngImport: i0, type: ToastOutletComponent, decorators: [{
            type: Component,
